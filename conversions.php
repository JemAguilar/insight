...
<title>Insight | Conversion Chart</title>
</head>
<body>
	<?php
		...
		<div class="row space">
			<div class="col-md-12">
				<div class="summary-chart">
					<div class="row">
						<div class="col-md-6">
							<h5 class="weight-600-Chart size-30">Conversions</h5> &nbsp;&nbsp;<span class="count-category-Chart size-30">(<?php echo $request->getConversions(); ?>)</span>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
	...
	$(document).ready(function() {
		...
		new Chart(document.getElementById("conversion-chart"), {
			...
			data: {
				...
				datasets: [{ 
					data: [0,<?php echo $request->getConversionsChartDatas();?>],
					fill: '#f4f4f6',
					borderColor:'#7d7d7d',
					pointRadius:0,
				}]
